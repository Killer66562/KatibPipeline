...
def get_spark_job_definition():
    ...
    import time
    # Read manifest file
    with open('spark-job-python-heart_disease.yaml', "r") as stream:
...
def compose_pipeline(
    ...
    change_model_task = change_model(
        ...
        old_model_file_path="/mnt/models/heart_disease_model_metrics.json", 
...
if __name__ == "__main__":
    compiler.Compiler().compile(compose_pipeline, "../compose_pipeline_heartDisease.yaml")

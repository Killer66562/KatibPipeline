# ========================================
# Dataset Preprocessing and Train/Test Split Script
#
# This script performs the following tasks:
# 1. Downloads a diabetes dataset from a public GitHub repository.
# 2. Cleans the dataset by:
#    - Removing entries with 'No Info' in the 'diabetes' column.
#    - Keeping only selected features (gender, age, bmi, HbA1c_level, blood_glucose_level, diabetes).
#    - Dropping rows with too many missing values.
#    - Encoding 'gender' into numerical values.
#    - Replacing 'No Info' entries with the mean value for numerical fields.
# 3. Splits the dataset into training and testing sets.
# 4. Saves the resulting datasets (X_train, X_test, Y_train, Y_test) into CSV files under the 'src/datasets/' directory.
#
# Libraries Used:
# - pandas
# - scikit-learn

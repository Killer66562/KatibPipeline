# ========================================
# Kubeflow Pipelines - Katib Hyperparameter Tuning Example
#
# This script defines a complete KFP pipeline with the following flow:
# 1. Use the load_data component to download and preprocess the dataset.
# 2. Use the prepare_data component to split the dataset into training and testing sets.
# 3. Use the create_katib_experiment_task component to:
#    - Launch a Katib experiment for hyperparameter tuning of an XGBoost model.
#    - Optimize for the highest possible accuracy score.
#
# Main Components:
# - load_data: Downloads and cleans the diabetes dataset.
# - prepare_data: Splits the dataset into X_train, X_test, Y_train, and Y_test.
# - create_katib_experiment_task: Creates a Katib hyperparameter tuning experiment.
#
# Finally, the pipeline is compiled into a YAML file, ready for deployment on Kubeflow Pipelines.
# ========================================
